...
const AddFamily = () => {
  ...
  const handleHeadSelect = (head) => {
    ...
    setFormData(prev => ({ ...prev, headId: head.id }));
  ...
  const validateForm = () => {
    ...
    if (!formData.headId) {
      newErrors.headId = 'Please select a family head';
    }
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-4 py-3 rounded-xl border focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${errors.headId ? 'border-red-300 bg-red-50' : 'border-gray-300'
                        }`}
                      disabled={submitting}
                    />
                    {searching && (
