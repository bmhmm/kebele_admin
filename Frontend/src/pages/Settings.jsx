...
const SettingsPage = () => {
  ...
  // Only 2 essential tabs
  const tabs = [
    { id: 'general', label: 'General Settings', icon: SettingsIcon },
    { id: 'user', label: 'User Management', icon: User },
  ];

  // Only 3 essential roles
  const roles = [
  ...
  const handleAddUser = (e) => {
    ...
    setUsers([...users, user]);
    setNewUser({ name: '', email: '', role: 'Data Entry', password: '' });
    setShowAddUser(false);
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Input
                      label="Kebele Name"
                      value={settings.kebeleName}
                      onChange={(e) => setSettings(prev => ({ ...prev, kebeleName: e.target.value }))}
              ...
              <Card className="border border-gray-200 shadow-sm">
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="border border-gray-200 rounded-xl p-4">
                      <h4 className="font-semibold text-gray-900 mb-2">Data Entry Clerk</h4>
                      <ul className="text-sm text-gray-600 space-y-1">
                        <li>• Add/Edit individuals</li>
                        <li>• Register families</li>
                        <li>• Add houses</li>
                        <li>• Issue ID cards</li>
                      </ul>
                    </div>
                    <div className="border border-gray-200 rounded-xl p-4">
                      <h4 className="font-semibold text-gray-900 mb-2">View Only</h4>
                      <ul className="text-sm text-gray-600 space-y-1">
                        <li>• View all data</li>
