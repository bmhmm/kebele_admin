...
import React, { useState, useEffect } from 'react';
import { Home, ArrowLeft, RefreshCw, List } from 'lucide-react'; // Added List icon
import AddHouseForm from '../components/forms/AddHouseForm';
import { Card, CardHeader, CardTitle, CardDescription, CardContent } from '../components/ui/Card';
import { Button } from '../components/ui/Button';
...
const AddHouse = () => {
  ...
  // ADD THIS FUNCTION
  const handleListHouses = () => {
    navigate('/list-houses'); // Navigate to list houses page
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-blue-300">Register House</h1>
            <p className="text-gray-400">Add a new house property to the system</p>
          </div>
        </div>

        {/* Button Group - UPDATED */}
        <div className="flex items-center space-x-3">
          {/* List Houses Button - ADDED */}
          <Button
            variant="outline"
            size="sm"
            onClick={handleListHouses}
