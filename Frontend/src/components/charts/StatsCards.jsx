...
// // components/charts/StatsCards.jsx
// import React from 'react';
...
//   statsData = {}
// }) => {
//   console.log('StatsCards received statsData:', statsData);

//   // ONLY 4 stats now (removed newRegistrations and activeThisWeek)
//   const stats = [
//     {
//       title: 'Total Individuals',
//       value: loading ? '...' : (statsData.individuals?.value || '0'),
//       change: loading ? '...' : (statsData.individuals?.change || '0%'),
//       positive: !(statsData.individuals?.change?.includes?.('-') || false),
//       // description: 'from last week'
//     },
//     {
//       title: 'Registered Families',
//       value: loading ? '...' : (statsData.families?.value || '0'),
//       change: loading ? '...' : (statsData.families?.change || '0%'),
//       positive: !(statsData.families?.change?.includes?.('-') || false),
//       // description: 'from last week'
//     },
//     {
//       title: 'Houses Registered',
//       value: loading ? '...' : (statsData.houses?.value || '0'),
//       change: loading ? '...' : (statsData.houses?.change || '0%'),
//       positive: !(statsData.houses?.change?.includes?.('-') || false),
//       // description: 'from last week'
//     },
//     {
//       title: 'ID Cards Issued',
//       value: loading ? '...' : (statsData.idCards?.value || '0'),
//       change: loading ? '...' : (statsData.idCards?.change || '0%'),
//       positive: !(statsData.idCards?.change?.includes?.('-') || false),
//       // description: 'from last week'
//     }
//   ];
...
//   const timeframeOptions = ['Today', 'This Week', 'This Month', 'This Year'];
...
//               Key metrics and statistics for your kebele
//             </CardDescription>
//           </div>
//           <div className="flex flex-wrap gap-2">
//             <div className="flex items-center space-x-2 bg-white rounded-xl border border-gray-300 p-1">
//               {timeframeOptions.map((option) => (
//                 <Button
//                   key={option}
//                   size="sm"
//                   variant={timeframe === option.toLowerCase().replace(' ', '-') ? 'secondary' : 'ghost'}
//                   className={`text-xs px-3 py-1 ${timeframe === option.toLowerCase().replace(' ', '-') ? 'bg-gray-100' : 'hover:bg-gray-50'}`}
//                   onClick={() => onTimeframeChange(option.toLowerCase().replace(' ', '-'))}
//                 >
//                   {option}
//                 </Button>
//               ))}
...
//       </CardHeader>
//       <CardContent>
//         {/* Changed from grid-cols-3 to grid-cols-4 for 4 cards */}
//         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
//           {stats.map((stat, index) => (
//             <div
//               key={index}
//               className="group p-6 bg-white rounded-2xl border-2 border-gray-200 hover:border-blue-100 shadow-sm hover:shadow-lg transition-all duration-300"
//             >
//               <div className="flex items-start justify-between mb-4">
//                 <h3 className="text-sm font-medium text-gray-600">{stat.title}</h3>
//                 <div className={`flex items-center space-x-1 px-2 py-1 rounded-full text-xs font-medium ${stat.positive ? 'bg-emerald-100 text-emerald-800' : 'bg-rose-100 text-rose-800'}`}>
//                   {stat.positive ? (
