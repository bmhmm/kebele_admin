...
// controllers/authController.js - TEMPORARY FIX FOR TESTING
const jwt = require('jsonwebtoken');
const User = require('../models/User');
...
exports.login = async (req, res) => {
    try {
        ...
        // TEMPORARY: For testing, compare plain passwords
        // (Remove this after testing and use bcrypt)
